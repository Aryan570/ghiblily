...
const Contact = () => {
    ...
    return (
        <div className='w-full flex flex-col md:flex-row justify-center items-center p-8 overflow-hidden'>
            <Image className='rounded-lg shadow-lg mx-auto' src={'/rises2trimmed.webp'} width={400} height={400} alt='rises' unoptimized />
