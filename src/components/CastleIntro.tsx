...
const Intro = () => {
  ...
  return (
    <div
      className='relative bg-gray-900 text-white flex items-center justify-center overflow-hidden'
      ref={sectionRef}
    >
      ...
      <div className="relative z-10 w-full max-w-6xl mx-auto p-6 flex flex-col md:flex-row items-center justify-center gap-8 md:gap-16">
        ...
        <div className="w-full md:w-[35%] text-center md:text-left p-4 bg-white/10 backdrop-blur-sm rounded-xl shadow-lg text-white flex-shrink-0">
          ...
          <p className="text-lg leading-relaxed">
            This is a completely separate and independent section designed to showcase a scroll-driven animation. As you scroll down the page and this section becomes visible, the green box will smoothly slide to the left, creating a distinct visual effect.
          </p>
