...
const About = () => {
  return (
    <div className='overflow-hidden text-gray-700'>
      <div className='flex relative justify-around '><Image className=' object-cover' src="/sky.jpg" fill={true} alt='castle' quality={100} />
        <ParallaxProvider><Parallax translateX={['400px', '0px']}><Image className=' mt-6' src="/castle.png" width={200} height={200} alt='castle' quality={100} /></Parallax></ParallaxProvider>
